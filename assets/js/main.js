...
(function () {
  ...
  /* --------------------------------------------------------------------
     Himmel: Sonne und Pollen. Sterne bleiben ungenutzt, solange Tag ist.
     -------------------------------------------------------------------- */
  function fillSky() {
    ...
    // Die Welt ist immer Tag — das ist die Stimmung, nicht die Uhrzeit.
    // Die Nachtfassung samt Sternenhimmel liegt vollständig in
    // _versionen/v1_2026-08-18_nacht/.
    body.classList.add('is-sun');

    // Aufsteigende Pollen. Jede Flocke bekommt eigene Dauer und Verzögerung,
    // damit kein sichtbarer Rhythmus entsteht.
    if (embers && !reduced) {
      var e2 = document.createDocumentFragment();
      for (var j = 0; j < 22; j++) {
        var e = document.createElement('span');
        var cool = Math.random() < 0.25;         // ein Viertel heller = Gegenlicht
